...
const SectionTag = ({
  ...
  text: string;
}) => <div className="inline-block bg-[#9CAAC6] text-white text-xs px-4 py-1.5 rounded-full mb-6 font-medium tracking-wide">
    {text}
  </div>;
...
const Method = () => {
  ...
  return <PageTransition>
      ...
      />
      {/* Hero Section */}
      <Section className="bg-[#FCF9F2] pt-12 md:pt-20">
