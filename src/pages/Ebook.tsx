      ...
      <Section className="pt-32 md:pt-40 bg-background">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
            {[
              { icon: Coffee, title: "Makkelijk & Voedzaam", desc: "Eenvoudige recepten die je snel kunt maken en vol zitten met voedingsstoffen." },
              { icon: Zap, title: "Energie Boost", desc: "Start je dag met ontbijtjes die je energie geven voor de hele dag." },
              { icon: Sparkles, title: "Hormonale Balans", desc: "Ontdek hoe kleine aanpassingen een groot verschil maken voor je hormonen." }
            ].map((item, i) => (
            ...
            <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-secondary/30 mb-20">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                  ...
                  <div className="space-y-6 text-muted-foreground leading-relaxed">
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        {[
                          "Op zoek bent naar makkelijke, voedzame en heerlijke ontbijtjes",
                          "Recepten wilt die je energie geven en je een goede start van de dag bezorgen",
                          "Wil ontdekken hoe kleine aanpassingen in je ontbijt een groot verschil kunnen maken"
                        ].map((item, i) => (
                          <motion.div
                            key={i}
                ...
                <div id="download-form">
                  <motion.div
                    className="bg-background p-8 rounded-2xl border border-secondary/30 sticky top-24"
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center justify-center max-w-4xl mx-auto">
              ...
              >
                <div className="rounded-2xl overflow-hidden max-w-[280px]">
                  <img src={ebookCoverFront} alt="E-book voorkant" className="w-full h-auto" />
                </div>
              </motion.div>
              <motion.div
                className="relative"
              ...
              >
                <div className="rounded-2xl overflow-hidden max-w-[320px]">
                  <img src={ebookCoverOpen} alt="E-book open" className="w-full h-auto" />
                </div>
              </motion.div>
            </div>
          </FadeIn>
