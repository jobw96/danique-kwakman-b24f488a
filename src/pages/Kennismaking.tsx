        ...
        <div className="flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="md:w-1/2 relative">
            <FadeIn delay={0.2} className="rounded-full overflow-hidden border-8 border-primary/20 shadow-xl">
              <img src={daniqueMatchCall} alt="Gratis kennismakingsgesprek met Danique Kwakman - ontdek welk traject bij jou past" className="w-full object-cover aspect-square" loading="lazy" decoding="async" />
            </FadeIn>
