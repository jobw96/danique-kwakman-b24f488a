...
export const STATIC_ROUTES: SitemapRoute[] = [
  ...
  { path: '/bloedsuikertraject', changefreq: 'weekly', priority: 0.8 },
  { path: '/recepten', changefreq: 'weekly', priority: 0.8 },
  { path: '/recepten/homemade-chocolade-granola', changefreq: 'monthly', priority: 0.7 },
  { path: '/recepten/homemade-gembershotjes', changefreq: 'monthly', priority: 0.7 },
  { path: '/recepten/eimuffins', changefreq: 'monthly', priority: 0.7 },
  { path: '/recepten/chocolade-smoothie', changefreq: 'monthly', priority: 0.7 },
  ...
  { path: '/recepten/carrot-cake-overnight-oats', changefreq: 'monthly', priority: 0.7 },
  { path: '/recepten/ontbijt-bordje', changefreq: 'monthly', priority: 0.7 },
  { path: '/recepten/frambozen-chiapudding', changefreq: 'monthly', priority: 0.7 },
