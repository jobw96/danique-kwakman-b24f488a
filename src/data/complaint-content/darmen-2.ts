...
export const darmenContent2: ComplaintContentMap = {
  ...
  'voedselintoleranties': {
    ...
    recognition: [
      ...
      'Bepaald fruit of producten met veel fruitsuiker geven je een vol of winderig gevoel.',
      'Een glas rode wijn, oude kaas of gerookte producten geeft je weleens hoofdpijn of een opgezette huid.',
    ...
    together: [
      ...
      'Waar zinvol verwijst Danique je door voor laboratoriumonderzoek of om coeliakie of een allergie te laten uitsluiten',
      'Met de CIRCLE-methode brengt ze eliminatie en herintroductie gestructureerd in kaart, in plaats van gokken',
