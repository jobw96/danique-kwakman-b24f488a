...
export const darmenContent2: ComplaintContentMap = {
  ...
  'maagzuur-en-verteringsklachten': {
    ...
    widerSignals: [
      'Vermoeidheid of concentratieproblemen, mogelijk samenhangend met een tekort aan B12 of ijzer',
      'Een opgeblazen gevoel dat verder in de dag toeneemt',
      'Weinig eetlust of snel geen trek meer hebben',
  ...
  'voedselintoleranties': {
    intro: [
      ...
      'Misschien heb je al het rijtje afgestreept dat je op internet vond: geen gluten meer, geen zuivel meer en toch blijven de klachten. Of je merkt dat een glas wijn of een stuk oude kaas je hoofdpijn geeft en vraagt je af of dat toeval is.\u00a0',
      'Je wilt weten waar je nou daadwerkelijk op reageert, zodat je niet onnodig producten hoeft te schrappen die geen kwaad kunnen. Met gericht uitzoeken via een eetdagboek en waar nodig laboratoriumonderzoek kunnen we onderzoeken waar je wel en niet goed op reageert.\u00a0',
    ],
    recognition: [
      'Je krijgt regelmatig een opgeblazen buik, buikpijn of vermoeidheid na het eten, zonder precies te weten waarop.',
      'Je hebt al meerdere producten uit je voeding geschrapt, maar de klachten blijven (deels) bestaan.',
      'Na zuivel merk je een opgeblazen gevoel of onrustige darmen, vooral bij grotere hoeveelheden.',
      'Een glas rode wijn, oude kaas of gerookte producten geeft je hoofdpijn.',
      'Je twijfelt of je gevoelig bent voor gluten en overweegt dit te laten uitsluiten.',
      'Je klachten wisselen per dag, waardoor het lastig is één boosdoener aan te wijzen.',
    ],
    ...
    widerIntro: 'Reacties op voeding staan vaak niet op zichzelf. Andere signalen die geregeld meespelen:',
    widerSignals: [
      'Huidklachten zoals jeuk, roodheid of eczeem na bepaalde producten',
      'Hoofdpijn die opspeelt na specifieke voeding of dranken',
      'Vermoeidheid die duidelijk samenhangt met wat je hebt gegeten',
      'Wisselende stoelgang naast een opgeblazen gevoel',
    ...
    faqHeading: 'Veelgestelde vragen over voedselintoleranties',
    faqs: [
      {
