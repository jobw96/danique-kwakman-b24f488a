...
export const onregelmatigeCyclusContent: ComplaintContentMap = {
  'onregelmatige-cyclus': {
    ...
    explanationHeading: 'Wat betekent een onregelmatige cyclus?',
    explanation: [
    ...
    factorsHeading: 'Wat kan er meespelen bij een onregelmatige menstruatie?',
    factorsIntro:
    ...
    widerHeading: 'Verder kijken dan je menstruatie',
    widerIntro:
    ...
    faqHeading: 'Veelgestelde vragen over een onregelmatige cyclus',
    faqs: [
      {
